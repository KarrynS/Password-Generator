...
console.log('password uppercase: ' + upperCase);
console.log('password lowercase: ' + lowerCase);
console.log('password numeric: ' + numeric);
console.log('password special char: ' + specialChar);
*/
